...
namespace WebThuVienV2.Controllers
{
    public class HoaDonController : Controller
    {
        ...
        {
            ViewBag.MaKH = new SelectList(db.KhachHangs, "MaKH", "Ho");
        ...
        public ActionResult Create([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,NgayGiao")] HoaDon hoaDon)
        {
            ...
            ViewBag.MaKH = new SelectList(db.KhachHangs, "MaKH", "Ho", hoaDon.MaKH);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MaHD,MaKH,MaNV,NgayLapHD,NgayGiao")] HoaDon hoaDon)
        {
            if (ModelState.IsValid)
            {
